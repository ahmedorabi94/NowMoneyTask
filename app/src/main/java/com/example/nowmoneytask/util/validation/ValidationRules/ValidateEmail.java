...
public class ValidateEmail implements IFieldValidation {
    ...
    public ValidateEmail(Context context, IVewError view, String value, String msg, int length, int lastLength) {

        IValidationRule[] iValidationRules = new IValidationRule[]{
                new Required(value, msg, length, lastLength),
                new Email(value, context.getString(R.string.appbar_scrolling_view_behavior))
        };
